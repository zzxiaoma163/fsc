...
import com.fsc.fscmonitor.controller.Action;
import com.fsc.fscmonitor.controller.HttpRoute;
import com.fsc.fscmonitor.controller.RequestBody;
                    ...
                    if (parameterAnnotation.length > 0) {
                        for (int j = 0; j < parameterAnnotation.length; j++) {
                            if (parameterAnnotation[j].annotationType() == RequestBody.class &&
                                ...
                                System.out.println(jsonBuf.toString(CharsetUtil.UTF_8));
